...
$(window).on("load", function () {
    ...
    $("body").on("change", ".theme-switch input:radio", function () {
        ...
        $.get(ctx + "sysuser/theme", {"theme": a, "username": userName}, function (r) {
...
function loadMain(obj) {
    ...
    breadcrumnHtml += "<li class='breadcrumb-item'><a style='text-decoration:underline' href='javascript:openMain(\"bread_"+uuid+"\")'>" + target_text + "</a></li>";
