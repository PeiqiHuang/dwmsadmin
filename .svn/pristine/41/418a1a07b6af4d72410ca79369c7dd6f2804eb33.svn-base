...
public class PathUtils {
     ...
     * @param prefix 静态资源路径
     */
    public static <T> void setAccessPath(T obj, String fieldName, String prefix) {
    ...
    public static <T> void setAccessPath(List<T> objs, String fieldName, String prefix) {
        for (T obj : objs) {
            setAccessPath(obj, fieldName, prefix);
        }
    }
    
    public static <T> void setImgAccessPath(List<T> objs, String fieldName) {
        setAccessPath(objs, fieldName, imageConfig.getAccessPath());
    }
    
    public static <T> void setFileAcessPath(List<T> objs, String fieldName) {
        setAccessPath(objs, fieldName, fileConfig.getAccessPath());
    }
