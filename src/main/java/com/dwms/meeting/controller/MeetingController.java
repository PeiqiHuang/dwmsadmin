...
public class MeetingController extends BaseController {
    ...
    public ResponseBo getMeeting(Integer mtgId) {
        try {
            MeetingWithUser meeting = this.meetingService.findById(mtgId);
    ...
    @ResponseBody
    public ResponseBo updateMeeting(Meeting meeting, String[] users) {
        try {
            this.meetingService.updateMeeting(meeting, users);
    ...
    @ResponseBody
    public ResponseBo deleteMeeting(String ids) {
        try {
