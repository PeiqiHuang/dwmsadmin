...
public class CourseController extends BaseController {
    ...
    @ResponseBody
    public ResponseBo addCourse(CourseForm form, MultipartFile coverImg, MultipartFile bannerImg, MultipartFile file) {
    	if (null == form.getPartyId()) {
    	    form.setPartyId(getPartyId());
    	}
        try {
            form.setFiles(new MultipartFile[]{coverImg, bannerImg, file});
    ...
    @ResponseBody
    public ResponseBo updateCourse(CourseForm form, MultipartFile coverImg, MultipartFile bannerImg, MultipartFile file) {//MultipartFile放在form中接收，不上传会报错
        try {
            form.setFiles(new MultipartFile[]{coverImg, bannerImg, file});
