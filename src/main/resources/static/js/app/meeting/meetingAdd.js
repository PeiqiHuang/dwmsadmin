...
//会议主持人
var $hosterSelect = $entityAddForm.find("select[name='hoster']");
var hosterSelect = new PartySelect($hosterSelect, "user/getUsers", "userId", "userName");
//党员多选
